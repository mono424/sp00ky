...
| `SPKY_CHANGEFEED_POLL_LIMIT` | Transactions per `SHOW CHANGES`. | `500` |
| `SPKY_CHANGEFEED_POLL_TIMEOUT_SECS` | Deadline for one `SHOW CHANGES`; past it the upstream handle is replaced. | `30` |
