...
export const themeCode = `createClient({
  // ...
  impersonationBanner: {
    theme: {
      heightPx: 56,
...
export const ownBannerCode = `// 1. Tell the client you are rendering it.
...
<CodeBlock code={themeCode} lang="typescript" />

<PropTable props={[
  { name: 'heightPx', type: 'number', default: '44', desc: 'Bar height, and how far the page is pushed down.' },
  { name: 'radiusPx', type: 'number', default: '14', desc: "The page's new top corners. `0` squares them off." },
  { name: 'background', type: 'string', default: 'hazard stripes', desc: 'Any CSS `background` for the warning layer.' },
  { name: 'pill', type: 'string', default: 'near-black', desc: 'Background of the pill the text sits in.' },
  { name: 'pillText', type: 'string', default: 'amber', desc: 'Text colour inside the pill.' },
  { name: 'accent', type: 'string', default: 'amber', desc: 'Stop button background.' },
  { name: 'accentText', type: 'string', default: 'near-black', desc: 'Stop button text colour.' },
  { name: 'stopLabel', type: 'string', default: "'Stop'", desc: 'Label of the button that ends the session.' },
  { name: 'label', type: '(info) => string', default: 'Impersonating …', desc: 'The sentence. Wrap a part in `**` to emphasise it; the result is text, never markup.' },
  { name: 'noPageShift', type: 'boolean', default: 'false', desc: 'Keep the bar but leave the page where it is (do your own offset with the CSS variable).' },
]} />
...
<CodeBlock code={ownBannerCode} lang="tsx" />
