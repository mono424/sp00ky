...
export const cssCode = `/* The framed page is laid out normally, so most apps need nothing. A header
...
<PropTable props={[
  { name: 'heightPx', type: 'number', default: '40', desc: 'Height of the bar above the page.' },
  { name: 'insetPx', type: 'number', default: '10', desc: 'Gutter left, right and below the page. `0` frames from the top only.' },
  { name: 'radiusPx', type: 'number', default: '14', desc: "The framed page's corners. `0` squares them off." },
  { name: 'background', type: 'string', default: 'amber wash + rake', desc: 'Any CSS `background` for the backdrop behind the page.' },
  { name: 'text', type: 'string', default: 'dark brown', desc: 'Warning text colour on the backdrop.' },
  { name: 'accent', type: 'string', default: 'dark brown', desc: 'Stop button background.' },
  { name: 'accentText', type: 'string', default: 'off-white', desc: 'Stop button text colour.' },
  ...
  { name: 'noPageShift', type: 'boolean', default: 'false', desc: 'Keep the bar but leave the page layout untouched (do your own offset with the CSS variable).' },
]} />
